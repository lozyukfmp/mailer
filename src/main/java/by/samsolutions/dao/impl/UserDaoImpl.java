...
public class UserDaoImpl extends GenericDaoImpl<User, String> implements UserDao
{
	...
	@Override
	public User findWithProfileAndPosts(final String username) throws NoResultException
	{
		return (User) entityManager.createNamedQuery("User.findWithProfileAndPosts")
		                           .setParameter("username", username)
		                           .getSingleResult();
